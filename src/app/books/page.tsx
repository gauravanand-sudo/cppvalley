...
export const metadata: Metadata = {
  ...
  description:
    "Interview-focused C++, HFT and systems reading paths from cppvalley, including Effective Modern C++, Effective STL, C++ Concurrency in Action and DDIA.",
        ...
        <section className="platform-page-hero">
          <div className="site-container lp-hero-inner">
            <div>
              ...
              <h1>Reading paths mapped to interviews and projects.</h1>
              <p>
                Use these books as focused preparation: learn the key ideas, code the relevant examples, and practice explaining each trade-off clearly.
              </p>
            ...
            <aside className="lp-hero-card">
              ...
              <p>Every useful reading note should produce a coding task, a project idea or a crisp interview explanation.</p>
            </aside>
          </div>
        </section>
            ...
            {books.map(([title, author, track, text]) => (
              <article className="lp-card" key={title}>
                <div className="lp-card-body">
                  ...
                  <p>{text}</p>
                  <Link className="lp-card-link" href="/blog">Read related articles</Link>
                </div>
              </article>
            ))}
          </div>
