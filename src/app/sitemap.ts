...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const corePages: MetadataRoute.Sitemap = [
    ...
    { url: "https://cppvalley.com/curriculum", lastModified, changeFrequency: "weekly", priority: 0.9 },
  ...
  const lessonCoursePages: MetadataRoute.Sitemap = youtubeSeries.map((series) => ({
  ...
  return [...corePages, ...coursePages, ...lessonCoursePages, ...lessonPages, ...blogPages, ...interviewPages];
}
